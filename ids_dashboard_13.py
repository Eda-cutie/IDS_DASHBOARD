...
if uploaded_file:
    ...
    if mode in ["IsolationForest", "RandomForest"]:
        ...
        # --- Column selection with Select All ---
        ...
        df_view = df_view[selected_columns]
        ...
        with c5:
            ...
            if "y_pred" in res["df"].columns:  # use original df for pie
                pie = px.pie(
                    res["df"],
                    names=res["df"]["y_pred"].map({0:"Benign", 1:"Attack"}),
